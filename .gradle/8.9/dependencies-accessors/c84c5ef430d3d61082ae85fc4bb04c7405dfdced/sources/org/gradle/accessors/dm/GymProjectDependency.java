...
@NonNullApi
public class GymProjectDependency extends DelegatingProjectDependency {

    @Inject
    public GymProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
