...
data class GymTypography(
    ...
    val emojiDisplaySmall: TextStyle = emoji.copy(
        fontSize = 36.sp,
        lineHeight = 44.sp,
    ),
    val emojiDisplayMedium: TextStyle = emoji.copy(
        fontSize = 45.sp,
        lineHeight = 52.sp,
    ),
    val emojiDisplayLarge: TextStyle = emoji.copy(
        fontSize = 57.sp,
        lineHeight = 64.sp,
        letterSpacing = (-0.25).sp,
    ),
    val emojiHeadlineLarge: TextStyle = emoji.copy(
        fontSize = 32.sp,
        lineHeight = 40.sp,
    ),
    val emojiHeadlineMedium: TextStyle = emoji.copy(
        fontSize = 28.sp,
        lineHeight = 36.sp,
    ),
    val emojiHeadlineSmall: TextStyle = emoji.copy(
        fontSize = 24.sp,
        lineHeight = 32.sp,
    ),
    val emojiTitleLarge: TextStyle = emoji.copy(
        fontSize = 22.sp,
        lineHeight = 28.sp,
    ),
    val emojiTitleMedium: TextStyle = emoji.copy(
        fontSize = 14.sp,
        lineHeight = (19.6).sp,
        letterSpacing = 0.25.sp,
    ),
    val emojiTitleSmall: TextStyle = emoji.copy(
        fontSize = 14.sp,
        lineHeight = 20.sp,
        letterSpacing = 0.25.sp,
    ),
    val emojiLabelLarge: TextStyle = emoji.copy(
        fontSize = 12.sp,
        lineHeight = 16.sp,
    ),
    val emojiLabelMedium: TextStyle = emoji.copy(
        fontSize = 12.sp,
        lineHeight = 16.sp,
    ),
    val emojiLabelSmall: TextStyle = emoji.copy(
        fontSize = 11.sp,
        lineHeight = 16.sp,
        letterSpacing = (-0.2).sp,
    ),
    val emojiBodyLarge: TextStyle = emoji.copy(
        fontSize = 16.sp,
        lineHeight = 24.sp,
        letterSpacing = 0.5.sp,
    ),
    val emojiBodyMedium: TextStyle = emoji.copy(
        fontSize = 14.sp,
        lineHeight = 20.sp,
        letterSpacing = 0.25.sp,
    ),
    val emojiBodySmall: TextStyle = emoji.copy(
        fontSize = 12.sp,
        lineHeight = 16.sp,
    ),
) {
